...
<template>
    <ActionSection>
        ...
        <template #description>
            Ajoutez une sécurité supplémentaire en activant la double authentification.
        </template>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600">
                <p>
                    Lorsque l'authentification à deux facteurs est activée, vous êtes invité à fournir un jeton sécurisé et aléatoire lors de l'authentification. Vous pouvez récupérer ce jeton à partir de l'application Google Authenticator de votre téléphone. 
                </p>
            </div>
